...
export class PacientesMedicoPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.tipoUsuario = this.loginService.getTipoUsuario(this.usuario);
    this.carregarDados();
  }
  ...
  carregarDados() {
    ...
    this.todasConsultas = this.consultaService.listarPorMedico(this.loginService.getUsuarioId(this.usuario));
    this.aplicarFiltro();
  }
